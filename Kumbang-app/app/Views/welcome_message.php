...
<head>
    ...
    <title>Penjadwalan Penggunaan Sarana</title>
    ...
    <script nonce="dd5ccbbf-e151-4acd-a861-c65e3331851c">
        (function(w, d) {
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="assets/dist/img/kumbang.png" alt="Logo SMA Kusuma Bangsa" class="brand-image">
                <span class="brand-text font-weight-bold text-md">SMA Kusuma Bangsa</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/dist/img/dashboard.png" style="width:24px;height:24px;">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block text-sm">Dashboard</a>
                    </div>
                </div>

                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/dist/img/sarana.png">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block text-sm">Sarana</a>
                    </div>
                </div>

                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/dist/img/penjadwalan.png">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block text-sm">Penjadwalan</a>
                    </div>
                </div>
